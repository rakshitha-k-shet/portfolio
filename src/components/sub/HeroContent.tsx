      ...
      <motion.div variants={itemVariants} className="space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative bg-card/40 backdrop-blur-sm border border-primary/20 rounded-2xl p-6 shadow-2xl">
            <h2 title="Software Engineer" className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary via-blue-500 to-primary bg-clip-text text-transparent mb-3">
              Software Engineer
            </h2>
        ...
        <div className="flex items-center gap-3">
          <TrackableContact method="github">
            <NavbarButton
              ...
              href="https://github.com/rakshitha-k-shet"
            >
          ...
          <TrackableContact method="linkedin" >
            <NavbarButton
              ...
              href="https://www.linkedin.com/in/rakshitha-k-9094b7210"
            >
