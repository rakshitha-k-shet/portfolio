...
export const timelineData: TimelineItem[] = [
  {
    ...
    company: 'Synopsys',
    location: 'Banglore',
    imageURL: '/synopsys.png',
    date: 'March 2024 - May 2025',
    description: 'Worked on real-time projects to gain hands-on experience.',
    achievements: [
      "Enhanced the messaging system, an object-based GUI error browser, by improving hierarchical categorization, and interactive HTML display.",
      "Enhanced Code quality by resolving 50+ critical coverity issues across multiple modules reducing post-release defects.",
      "Integrated APIs enhancing efficiency and reducing execution time",
      "Enhanced module efficiency by working on Include what you use tool which eliminates unnecessary includes, reducing compilation time and improving build performance.",
      "Developed a project to report virtual memory usage for every module, improving resource monitoring and analysis.",
    ],
  ...
  return (
    <section id="experience" className="relative py-20 text-foreground transition-colors overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h1 title="Professional Experience" className="text-4xl sm:text-5xl font-bold tracking-tight bg-gradient-to-r from-foreground via-primary to-blue-500 bg-clip-text text-transparent mb-4">
